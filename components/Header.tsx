  ...
  return (
    <header className="px-[1rem] py-[0.5rem] h-[9vh]">
      <nav className="flex justify-between items-center lg:w-full">
        ...
        <div className="hidden lg:block px-[2rem]">
          <Link href={"/generate"} className=" flex justify-end">
            <p className="text-xl bg-gradient-to-r cursor-pointer from-[#A100FF] to-[#FE00AD] px-[1.5rem] py-[0.5rem] rounded-full font-semibold transition-transform ease-linear delay-100 hover:scale-110">
              Get Started
            </p>
          </Link>
        </div>
